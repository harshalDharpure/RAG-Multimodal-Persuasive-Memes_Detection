# 🎯 RAG-Enhanced Hierarchical Multimodal Fusion for Persuasive Meme Detection
...
We follow PEP 8 guidelines. Please run:
```bash
black .
flake8 .
```
...
```bibtex
@article{rag_persuasive_memes_2024,
  title={RAG-Enhanced Hierarchical Multimodal Fusion for Persuasive Meme Detection: From Binary Classification to Persuasion Type Identification},
